...
export function ImageInputNode({ data }: { data: any }) {
  ...
  const addUrl = () => {
    ...
    if (url && images.length < 4) setImages((prev) => [...prev, url]);
  };
  ...
  return (
    <div className="p-3 min-w-[200px]">
      ...
      <div className="flex gap-1 mb-2">
        <button onClick={() => document.getElementById("file-input")?.click()} className="p-1.5 rounded bg-[#2a2a3e] hover:bg-[#3a3a4e]">
